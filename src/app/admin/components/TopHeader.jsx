...
export function TopNav({ user, onMenuClick, onProfileClick, onSettingsClick, logout }) {
    ...
    const photoUrl = getStorageUrl(user?.profile?.photo) || user?.profile?.avatar;
    const fallbackUrl = `https://ui-avatars.com/api/?name=${user?.name || 'User'}&background=0D8ABC&color=fff`;
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="relative border-l border-slate-200 pl-4" ref={dropdownRef}>
                    ...
                    >
                        ...
                        <img
                            src={imgError ? fallbackUrl : (photoUrl || fallbackUrl)}
                            alt="Profile"
